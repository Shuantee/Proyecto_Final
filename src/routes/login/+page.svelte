    ...
    <div class="login-container">
      ...
      <div class="box">
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="text" placeholder="Ingresa tu nombre" bind:value={name} />
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="email" placeholder="Ingresa tu correo" bind:value={email} />
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="password" placeholder="Ingresa tu PIN" bind:value={pin} />
          </div>
        </div>
